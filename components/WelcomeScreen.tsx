...
const WelcomeScreen: React.FC<WelcomeScreenProps> = ({ onWatchVideo, onGoToGame }) => {
  return (
    <div className="relative min-h-screen w-full flex flex-col items-center justify-center font-sans text-white p-4">
      ...
      <div className="relative z-10 w-full max-w-4xl p-4 md:p-8 border-8 rounded-xl bg-gray-200 text-black shadow-2xl animate-pulse-lava-frame max-h-[95vh] overflow-y-auto"
           style={{ borderColor: '#4a2c2a' }}>
        <h1 className="font-arcade text-4xl sm:text-5xl md:text-6xl text-center text-purple-700" style={{ textShadow: '2px 2px 0px #c4b5fd' }}>
          ¡Bienvenido a LIGA-Z!
        </h1>

        <div className="font-arcade text-sm md:text-base mt-6 text-gray-800 space-y-4 text-left leading-relaxed px-2 md:px-4">
          <p>
